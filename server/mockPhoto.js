/**
 * The fake property photographs, drawn rather than stored.
 *
 * Twelve scenes as SVG, shared by the two runtimes that need them: the local relay renders them
 * once to JPEG on disk (scripts/generate-mock-photos.mjs), and the deployed demo serves the SVG
 * straight from a function. Nothing binary ships in the build for a fake photograph — and the
 * demo stops showing the grey placeholder that made every listing look broken.
 */
const PALETTES = [
...
export const MOCK_PHOTO_COUNT = 12
