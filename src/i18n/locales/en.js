export default {
  ...
  props: {
    ...
    form: {
      ...
      essentials: 'The essentials', advanced: 'Advanced details', advancedHint: 'Characteristics, extras and description', cadastral: 'Cadastral reference', cadastralPh: '0000000XX0000X', cadastralHint: 'Refreshed by the GPS and by every saved address, from the Spanish cadastre.',
      locating: 'Locating…', reading: 'Reading…', noGeolocation: 'This device does not support location.', geoDenied: 'You denied access to your location. Allow it in the browser settings.', geoFailed: 'Could not get the location.', geoNoAddress: 'No address at that point.', searchOwner: 'Search', searching: 'Searching…', ownerPhonePh: '600 000 000', ownerPhoneHint: 'Look them up by phone first: that is what prevents a duplicate in Inmovilla.', ownerPhoneShort: 'At least 6 digits to search.', ownerFound: 'Already in Inmovilla: {name}. They will be linked to the listing.', ownerNotThem: 'Not them, create another', ownerNotFound: 'No contact with that number. A new one will be created.',
      ...
      price: 'Sale price (€)', priceRent: 'Monthly rent (€)', type: 'Property type',
      ...
      descField: 'Description', descPh: 'Layout, light, renovations, surroundings, nearby services…', chars: '{n} characters',
  ...
  clients: {
    ...
    form: {
      lookupHint: 'Look them up by phone first: that is what prevents a duplicate in Inmovilla.', lookupFound: 'Already in Inmovilla: {name} (no. {id}).', lookupOpen: 'Open their sheet', lookupNone: 'No contact with that number. One will be created.', lookupNoKey: 'Without the agency REST key, Inmovilla cannot be searched.', title: 'New client', editTitle: 'Edit client', contact: 'Contact details', name: 'First name', surname: 'Last name', mobile: 'Mobile', phone: 'Landline', email: 'Email', nif: 'ID number', address: 'Address', street: 'Street', number: 'Number', cp: 'Postal code', city: 'City', province: 'Province', notes: 'Notes', notesPh: 'What they look for, contact hours, next steps…', save: 'Save client', saveChanges: 'Save changes' },
    detail: {
      remoteMissing: 'This contact is no longer in Inmovilla; the copy on this device is kept.', back: 'Clients', rejected: 'Inmovilla rejected the contact: {msg}. Fix the data and save again.', contact: 'Contact', mobile: 'Mobile', phone: 'Landline', email: 'Email', nif: 'ID', address: 'Address', agent: 'Agent', followUps: 'Follow-ups', notInInmovilla: 'Follow-ups can be added once the client is in Inmovilla.', noFollowUps: 'No follow-ups for this client on this device.', notes: 'Notes', created: 'Created', updated: 'Updated', delete: 'Delete client', confirm: 'Delete {name}{also}?', alsoInmovilla: ' in Inmovilla too', saved: 'Client saved', gone: 'This client does not exist or was deleted.' },
